                                ...
                                <div class="signup-search-area">
                                    <div class="login_register_area justify-content-end">
                                        <div class="login/Registration">
                                            <button class="btn btn-submit login_register" data-toggle="modal" data-target="#myModal">Войти</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane active" id="Login"> 
                                ...
                                <div class="form-group"> 
                                    <label for="email" class="col-sm-12 control-label"> 
                                        Вход по почте </label> 
                                    <div class="col-sm-12"> 
                                        <input type="email" class="form-control" id="email1" placeholder="i.ivanov@example.ru" /> 
                                    </div> 
                                </div> 
                                <div class="form-group"> 
                                    <div class="col-sm-12"> 
                                ...
                                <div class="row"> 
                                    <div class="col-sm-12"> 
                                        <button type="submit" class="btn blt-login btn-submit btn-lg btn-block ">Войти</button> 
